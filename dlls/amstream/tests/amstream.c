...
static void test_audiostreamsample_update(void)
{
    ...
    ok(hr == S_OK, "Got hr %#x.\n", hr);
    IMediaSample_AddRef(media_sample1);
    ...
    ok(hr == S_OK, "Got hr %#x.\n", hr);
    IMediaSample_AddRef(media_sample2);
